        ...
        <div className='grid gap-6 lg:grid-cols-5'>
          <div className='flex flex-col gap-7 lg:col-span-3'>
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='flex flex-col gap-0.5'>
                <span className='text-xl font-medium'>HomeHaven Realty</span>
                <span className='text-muted-foreground text-sm'>hello@homehaven.com</span>
              </div>
            </div>
          ...
          <Card className='gap-4 py-4 shadow-none lg:col-span-2'>
            <CardHeader className='gap-1'>
              <CardTitle className='text-lg font-semibold'>Rent collection</CardTitle>
            </CardHeader>
